...
function showToast(message) {
    ...
    // Remove the toast after 5 seconds (increased from 3 seconds for longer visibility)
    setTimeout(() => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    sizeSelect.addEventListener('change', function() {
        ...
        if (selectedSize === '2XL' || selectedSize === '3XL') {
            priceElement.textContent = '380';
        } else if (selectedSize) {
            priceElement.textContent = '350';
        }
    });

    // Update buy button click handler
    ...
    buyButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            const productName = 'Performance T-Shirt';
